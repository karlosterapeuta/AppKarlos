...
import Card from 'components/ui/Card' // Ensure this is a default import
import EmotionalAssessment from 'components/hawkins/EmotionalAssessment_final' // Updated to point to the final version
